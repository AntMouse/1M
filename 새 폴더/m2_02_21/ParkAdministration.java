...
public class ParkAdministration {
	...
	// 공룡 관리
	// 공룡 999마리 추가
    private Dinosaur[] dino = new Dinosaur[999];
    // 공룡 문자열 변수
    ...
    // 각 공룡 추가 메서드 통합 관리
    public void addDinosaur(int index, String size, String diet, Dinosaur dinosaur) {
    ...
    private void printSingleDinoInfo(int index) {
        ...
        Dinosaur currentDino = dino[index];
    ...
    // 직원 관리
    // 직원 999명 추가
    private Employee[] employee = new Employee[999];
    // 직원 문자열 변수
    ...
    // 각 직원 추가 메서드 통합 관리
    public void addEmployee(int index, String name, int empld, Employee employee, String...schedules) {
        if (0 <= index && index < this.employee.length) {
            if (isEmployeeRegistered(index)) {
            	this.employee[index] = new Employee(name, empld, schedules);
            } else {
    ...
    private void printSingleEmployeeInfo(int index) {
        ...
        Employee currentEmployee = employee[index];
