...
public class Test8_Q6_Enclosure {
    private Test8_Q1_Dino2[] dinosaurs;

    public Test8_Q6_Enclosure(int capacity) {
        dinosaurs = new Test8_Q1_Dino2[capacity];
    }

    public void addDinosaur(Test8_Q1_Dino2 dinosaur, int index) {
    ...
    public boolean isEnclosureSafe(int index) {
    	if (0 <= index && index < dinosaurs.length) {
            Test8_Q1_Dino2 dino = dinosaurs[index];
            if (dino != null) {
